...
// return Object.values(this.state.Booltals).map((key)=>{
//   console.log(this.state.Booltals[0][0])

      if(Sl === this.state.Booltals[0].book){
       return  <RaisedButton   primary={true} className="setLeft" onClick={this.setCon.bind(this,index,a)}>{Sl }m</RaisedButton>
   }
   else{
      return  <RaisedButton disabled={true}   primary={true} className="setLeft" onClick={this.setCon.bind(this,index)}>{Sl }</RaisedButton>
   }
